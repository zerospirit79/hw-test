...
class DialogManager:
    ...
    def msgbox(self, text: str, title: str = '', width: int = 60, height: int = 10) -> int:
        ...
        if self.gui_available:
            cmd = [
                'yad', '--width', str(width),
                '--title', title or self.l10n.get('program_name'),
                '--text', text,
                '--button', 'gtk-ok:0',
    ...
    def entry(self, text: str, title: str = '', entry_label: str = '', 
              entry_text: str = '', width: int = 60, height: int = 10) -> Optional[str]:
    ...
    def checklist(self, title: str, text: str, items: List[Tuple[str, str, bool]], 
                  width: int = 80, height: int = 20) -> List[str]:
        """
        ...
        if self.gui_available:
            cmd = [
                'yad', '--width', str(width), '--height', str(height),
                '--title', title,
                '--text', text,
                '--checklist',
            ]
            ...
            cmd = [
                ...
                '--title', title,
                '--checklist', text,
                str(height), str(width), str(len(items)),
            ]
    ...
    def radiolist(self, title: str, text: str, items: List[Tuple[str, str, bool]], 
                  width: int = 60, height: int = 10) -> Optional[str]:
        """
    ...
    def progress(self, title: str, text: str, percentage: int, 
                 width: int = 400, height: int = 100) -> bool:
        """
        Show progress bar.
    ...
    def config_form(self, config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        test_items = [
            ...
            ('firmware_check', self.l10n.get('step_firmware_check'), config.get('fwupd_available', False)),
            ('syslogs', self.l10n.get('step_syslogs'), True),
            ('express_test', self.l10n.get('step_express_test'), config.get('express_available', False)),
