...
class CpuPowerStep(BaseHWStep):
    ...
    def _check_scaling_support(self) -> Dict[str, Any]:
        ...
        min_freq = self._get_scaling_freq(0, 'cpuinfo_min_freq') or \
                   self._get_scaling_freq(0, 'scaling_min_freq')
        max_freq = self._get_scaling_freq(0, 'cpuinfo_max_freq') or \
                   self._get_scaling_freq(0, 'scaling_max_freq')
