        ...
        try:
            for entry in os.listdir("/sys/block"):
                ...
                if (
                    ...
                    or entry.startswith("ram")
                    or entry.startswith("sr")
                    or entry.startswith("dm-")
                    or entry.startswith("md")
                ):
                    continue
    ...
    def execute(self) -> StepResult:
        ...
        try:
            ...
            if results:
                ...
                seq_write = [
                    r["sequential_write_mbs"] for r in results if r["sequential_write_mbs"]
                ]
